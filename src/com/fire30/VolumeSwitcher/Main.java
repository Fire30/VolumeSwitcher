	...
	static void initialize() {
		MS.hookClassLoad("com.android.internal.policy.impl.PhoneWindowManager", new MS.ClassLoadHook() {
			...
			public void classLoaded(Class<?> resources) {
				...
				try {
					interceptKeyBeforeQueueing = resources.getMethod("interceptKeyBeforeQueueing",KeyEvent.class,Integer.TYPE,Boolean.TYPE);
				} catch (Exception e) {
					interceptKeyBeforeQueueing = null;
				}
				if (interceptKeyBeforeQueueing != null) {
					MS.hookMethod(resources, interceptKeyBeforeQueueing, new MS.MethodAlteration<Object, Integer>() {
						@Override
						public Integer invoked(final Object resources, Object... args)
							...
							boolean isMusicActive = (Boolean) resources.getClass().getDeclaredMethod("isMusicActive").invoke(resources,(Object[])null);
							boolean down = (event.getAction() == KeyEvent.ACTION_DOWN);
							Object telephonyService = resources.getClass().getDeclaredMethod("getTelephonyService").invoke(resources,(Object[])null);
							...
							final Method sendMediaButtonEvent = resources.getClass().getDeclaredMethod("sendMediaButtonEvent",Integer.TYPE);
							final Method handleVolumeKey = resources.getClass().getDeclaredMethod("handleVolumeKey",Integer.TYPE,Integer.TYPE);
							final int ACTION_PASS_TO_USER = resources.getClass().getInterfaces()[0].getDeclaredField("ACTION_PASS_TO_USER").getInt(null);
